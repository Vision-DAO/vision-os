...
export type CommitmentStructOutput = [string, BigNumber, number] & {
  dependent: string;
  weight: BigNumber;
  nature: number;
};
...
export interface IdeaInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "commitVotes",
    values: [PromiseOrValue<string>, CommitmentStruct]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ProposalAccepted(address,string,string)": EventFragment;
    "ProposalRejected(address)": EventFragment;
...
export interface Idea extends BaseContract {
  ...
  filters: {
    ...
    "ProposalAccepted(address,string,string)"(
      proposal?: null,
      oldPayload?: null,
      newPayload?: null
    ...
    "ProposalRejected(address)"(proposal?: null): ProposalRejectedEventFilter;
    ProposalRejected(proposal?: null): ProposalRejectedEventFilter;
